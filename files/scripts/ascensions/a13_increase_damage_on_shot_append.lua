...
function shot(projectile_entity_id)
  ...
  ComponentSetValue2(projectile_component_id, "damage", damage * DAMAGE_MULTIPLIER)

  local explosion_damage = ComponentObjectGetValue2(projectile_component_id, "config_explosion", "damage")
  ComponentObjectSetValue2(projectile_component_id, "config_explosion", "damage", explosion_damage * DAMAGE_MULTIPLIER)
end
